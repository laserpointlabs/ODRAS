...
class PrefixCreate(BaseModel):
    prefix: str = Field(..., description="Prefix (lowercase letters and numbers only, 2-20 chars)")
        ...
        try:
            with conn.cursor() as cur:
                ...
                cur.execute(
                    ...
                    VALUES (%s, %s, %s, %s, %s)
                    """,
                    (prefix_id, prefix.prefix, prefix.description, prefix.owner, admin_user["email"])
                )
                conn.commit()
