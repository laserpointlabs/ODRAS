...
class QdrantService:
    ...
    def ensure_collection(
        ...
        try:
            ...
            logger.info(
                f"Created Qdrant collection '{collection_name}' with vector size {vector_size} and {distance} distance"
            )
            return True
    ...
    def search_vectors(
        ...
        try:
            ...
            logger.info(
                f"Found {len(results)} results in collection '{collection_name}' with threshold {score_threshold}"
            )
            return results
    ...
    def delete_vectors(self, collection_name: str, point_ids: List[str]) -> bool:
        ...
        try:
            ...
            self.client.delete(
                collection_name=collection_name, points_selector=rest.PointIdsList(points=point_ids)
            )
    ...
    def delete_by_filter(self, collection_name: str, metadata_filter: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.info(
                f"Deleted vectors from collection '{collection_name}' matching filter: {metadata_filter}"
            )
            return True
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "unhealthy", "error": str(e), "qdrant_available": False}
