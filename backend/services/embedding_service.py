...
class EmbeddingService:
    ...
    def _get_model_configurations(self) -> Dict[str, Dict[str, Any]]:
        ...
        configs = {
            ...
            'text-embedding-ada-002': {
                ...
                'available': OPENAI_AVAILABLE and bool(getattr(self.settings, 'openai_api_key', None))
            },
    ...
    def load_model(self, model_id: str) -> bool:
        ...
        try:
            ...
            if not config['available']:
                logger.error(f"Model '{model_id}' is not available (missing dependencies or configuration)")
                return False
    ...
    def generate_single_embedding(self, text: str, model_id: str = 'all-MiniLM-L6-v2') -> List[float]:
        """
