    ...
    def extract_comprehensive_metadata(self, text: str) -> DocumentMetadata:
        ...
        if not text or not text.strip():
            return DocumentMetadata(
                ...
                avg_sentence_length=0.0, requirements=[], systems=[],
                keywords=[], domain=None, quality_score=0.0,
                document_type='unknown', confidence_score=0.0,
                extracted_at=datetime.now(), extraction_method='pattern_based',
...
def get_metadata_extraction_service(settings: Settings = None) -> MetadataExtractionService:
