...
class NamespaceURIGenerator:
    ...
    def generate_ontology_uri(self, 
                            namespace_type: str,
                            ...
                            ontology_name: str = "ontology") -> str:
        """
        ...
        if namespace_type == "core":
            ...
            logger.warning(f"Invalid namespace type '{namespace_type}' or missing required parameters. Using fallback.")
    ...
    def generate_ontology_header(self, 
                               ontology_uri: str,
                               title: str,
                               description: str = "",
                               version: str = "1.0.0",
