...
class ResourceURIService:
    ...
    def generate_project_uri(self, project_id: str) -> str:
        ...
        Example: https://xma-adt.usnc.mil/core/7e43e3b4-0f60-4b52-ad72-1295b288645a/
        """
        ...
        # Use namespace path directly (odras prefix is already in base_uri if needed)
        if namespace_path:
            return f"{base_uri}/{namespace_path}/{project_id}/"
        else:
            # Fallback for projects without namespace
            return f"{base_uri}/projects/{project_id}/"
