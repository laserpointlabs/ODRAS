...
class TestOntologyEndpoints:
    ...
    async def test_delete_ontology_class(self, client, auth_token):
        ...
        response = await client.delete(
            "/api/ontology/classes/DeleteTestClass",
            headers=headers
        )
    ...
    async def test_delete_ontology_property(self, client, auth_token):
        ...
        # Now delete it
        response = await client.delete(
            "/api/ontology/properties/deleteTestProperty",
            headers=headers
        )
    ...
    async def test_mint_iri(self, client, auth_token):
        ...
        iri_data = {
            "local_name": "TestResource",
            "namespace": "http://example.org/"
        }
        
        response = await client.post(
            "/api/ontology/mint-iri",
            headers=headers,
            json=iri_data
        )
