    ...
    try:
        ...
        if variables_response.status_code == 200:
            ...
            try:
                ...
                result['error'] = f"Could not get variables (status: {variables_response.status_code})"
...
def extract_results(process_data: dict):
    ...
    # Show key variables
    key_vars = ['user_query', 'final_response', 'retrieval_stats', 'context_quality_score', 'reranked_context']
