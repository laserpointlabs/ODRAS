#!/usr/bin/env python3
"""
Repopulate Qdrant vectors from PostgreSQL chunks

This script reads chunks from PostgreSQL and recreates vectors in Qdrant
to fix the dual-write issue where chunks exist in SQL but not in vectors.
"""
...
async def repopulate_qdrant():
    ...
    try:
        ...
        logger.error(f"Error repopulating Qdrant: {e}")
        raise

if __name__ == "__main__":
    asyncio.run(repopulate_qdrant())
