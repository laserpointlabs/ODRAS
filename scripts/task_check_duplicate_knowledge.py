        ...
        for item in similar_items:
            ...
            if combined_score >= similarity_threshold:
                duplicate_candidates.append({
                    ...
                    'duplicate_type': classify_duplicate_type(combined_score, content_similarity, title_similarity)
                })
...
def classify_duplicate_type(combined_score: float, content_similarity: float, title_similarity: float) -> str:
