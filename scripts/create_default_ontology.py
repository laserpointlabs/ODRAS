...
DEFAULT_ONTOLOGY_FILE = os.path.join(os.path.dirname(__file__), "../data/default_project_ontology.json")
    ...
    async def populate_ontology(self, graph_iri: str):
        ...
        async with httpx.AsyncClient(timeout=60) as client:
            ...
            if save_response.status_code == 200:
                ...
                logger.error(f"Failed to save to Fuseki: {save_response.status_code} - {save_response.text}")
                return False
